...
export const SchemesCorner: React.FC<SchemesCornerProps> = ({ onOpenWelfareModal }) => {
  const schemes: SchemeDetail[] = [
    ...
    },
    {
      ...
      description: 'Free bicycles distributed to students studying in Classes IX, X, XI, and XII to facilitate safe and hassle-free daily commute to school.',
      eligibility: 'Classes IX to XII students',
