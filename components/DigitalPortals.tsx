          ...
          <div className="bg-[#FAF7F0] text-slate-900 rounded-3xl max-w-xl w-full p-6 md:p-8 border border-[#DFD7C7] shadow-2xl relative space-y-6 animate-in fade-in zoom-in duration-200">
              ...
              <div className="space-y-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h3 className="font-serif font-extrabold text-2xl text-[#0F2E23]">Student Profile & Oasis Scholarship</h3>
                  </div>
                </div>
              ...
              <div className="space-y-5">
                ...
                {formSubmitted ? (
                  <div className="bg-rose-50 border border-rose-200 text-rose-900 p-6 rounded-2xl text-center space-y-2">
                    ...
                    <p className="text-xs text-slate-600">Your reference ticket number has been generated. The Headmaster & Internal Complaints Committee will review your report within 24 hours.</p>
                  </div>
                ) : (
                  <form onSubmit={handleFormSubmit} className="space-y-3 text-xs">
                    <p className="text-slate-600">
                      Report any concerns regarding campus safety, harassment, anti-ragging, or infrastructure directly to the Headmaster. Submissions can be completely anonymous.
                    </p>
                    <input
                      required
                      type="text"
                    ...
                    <select className="w-full bg-white border border-[#DFD7C7] rounded-xl px-3.5 py-2.5 text-xs text-slate-900 focus:outline-none focus:border-[#881337]">
                      ...
                      <option>Oasis Scholarship / Grant Dispersal</option>
                    </select>
                    <textarea
                      required
                      rows={3}
              ...
              <div className="space-y-5">
                ...
                {formSubmitted ? (
                  <div className="bg-purple-50 border border-purple-200 text-purple-900 p-6 rounded-2xl text-center space-y-2">
                    ...
                    <p className="text-xs text-slate-600">Your valuable suggestion helps us improve the quality of education and facilities at MRHS.</p>
                  </div>
                ) : (
                  <form onSubmit={handleFormSubmit} className="space-y-3 text-xs">
                    <p className="text-slate-600">
            ...
            {activeModal === 'alumni' && (
              <div className="space-y-5">
                ...
                <p className="text-xs text-slate-700 leading-relaxed bg-white p-4 rounded-2xl border border-[#DFD7C7]">
                  Connecting generations of former students of Mahishadal Raj High School since 1945. Join the Praktani Sabha network to mentor current boys, sponsor merit scholarships, and attend annual reunions.
                </p>
            ...
            {activeModal === 'appraisal' && (
              <div className="space-y-5">
                ...
                <p className="text-xs text-slate-700 leading-relaxed bg-white p-4 rounded-2xl border border-[#DFD7C7]">
                  WBBSE & WBCHSE mandated performance evaluation portal for teaching staff. Facilitates peer reviews, student feedback integration, academic publishing records, and Headmaster appraisal.
                </p>
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  ...
                  <div className="bg-blue-50 p-3.5 rounded-2xl border border-blue-200">
                    <p className="font-bold text-blue-950">Headmaster Desk</p>
