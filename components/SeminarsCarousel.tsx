  ...
  const events: CulturalEvent[] = [
    {
      ...
      description: 'students demonstrated working models on solar energy, robotics, rainwater harvesting, and chemistry reaction practicals before district education officials.',
    ...
    {
      id: '3',
      title: 'Oasis Scholarship Karate Self-Defense & Yoga Boot-Camp',
      date: '15 JUL 2026',
      venue: 'School Sports Ground',
      description: 'Intensive self-defense martial arts training and daily yoga routines conducted under West Bengal State Oasis Scholarship Prakalpa wing for student safety.',
