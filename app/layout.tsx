...
export const metadata: Metadata = {
  title: "Mahishadal Raj High School (H.S.) | Official Portal",
  description: "Official web portal of Mahishadal Raj High School (H.S.), Purba Medinipur, West Bengal. Estd. 1945. Affiliated to WBBSE & WBCHSE.",
};
